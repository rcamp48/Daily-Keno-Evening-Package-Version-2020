REM *** Daily Keno evening Package Version 2019
...
LOCATE 6, 11
PRINT "  Daily Keno evening Package Version 2019  Copyright 2018  "
...
NEXT
IF diskcopy$ = "Y" THEN
    PRINT #2, USING "On ## ## ####  The  winning numbers in the evening   were :  ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##"; month; day; year; a1; b1; c; d; e; f; g; h; i1; j1; k1; l1; n1; o1; p1; q1; r1; s1; t1
...
IF crs$ = "Y" THEN COLOR 10, 5
LOCATE 5, 8
PRINT "        Daily Keno Package evening Version 2019  Main Menu         "
...
ELSEIF answer$ = "%" THEN
    ...
    serial$ = reg2$
    version$ = "Daily Keno evening Version"
...
IF crs$ = "Y" THEN COLOR 10, 5
LOCATE 3, 7
PRINT "            Daily Keno Version 2019 evening Barchart Menu           "
LOCATE 13, 7
PRINT ""
LOCATE 5, 7
IF crs$ = "Y" THEN COLOR 15, 3
...
GOTO searchmenu
enter:
OPEN "kenoevening.dat" FOR APPEND AS #1
beginning:
CLS
PRINT
PRINT "Daily Keno evening Version 2019 Winning Numbers Entry"
PRINT "----------------------------------------------------"
PRINT
...
ELSEIF answer$ = "YES" THEN
    OPEN "kenoevening.dat" FOR OUTPUT AS #1
    CLOSE #1
END IF
GOTO main
buildchart:
...
linecounter = 0
ERASE chart
OPEN "kenoevening.dat" FOR INPUT AS #1
DO UNTIL EOF(1)
...
LOCATE 4, 18
PRINT "      Daily Keno evening Version 2019 Print Menu         "
PRINT
IF crs$ = "Y" THEN COLOR 3, 8
LOCATE 3, 17
PRINT CHR$(201)
...
PRINT
PRINT "Thanks for using Daily Keno Eveing Package Version 2019"
PRINT
PRINT "Press any key to continue ...."
DO WHILE INKEY$ = ""
LOOP
