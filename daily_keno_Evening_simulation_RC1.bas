...
DIM temp(maxdraw)
DIM temp2(maxdraw)
DIM temp3(maxnumbers + bonus)
DIM temp4(maxnumbers + bonus)
DIM entry(maxnumbers + bonus)
DIM entrynumber(maxdraw)
DIM entrypick(maxdraw)
DIM month$(12)
DIM numb(maxnumbers)
DIM chart(500000, maxnumbers + bonus)
...
DO UNTIL EOF(1)
    ...
    INPUT #1, enternumbers(i, 1), enternumbers(i, 2), enternumbers(i, 3)
    FOR i = 4 TO maxdraw + bonus
        ...
        chart(linecounter, i) = enternumbers(linecunter, i)
        linecounter = linecounter + 1
    NEXT i
LOOP
CLOSE #1
